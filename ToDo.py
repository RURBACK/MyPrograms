...
b = 'Возраст: '
c = 'Рост: '
# Определяем строки для значений словаря
random_date = random.randint(1, 30) # Генерируем случайное число от 1 до 30
d = 'Дата: ' + str(random_date) # Преобразуем число в строку
...
while True:
    ...
    if command == 'help':  # Команда для вывода справки
        ...
        print(Back.RED +f"Запись создана!: {task}")  # Выводим информацию о пользователе
        ...
        task['Дата: '] = random_date # Записываем рандомную дату в словарь
        print(Back.RED +f"Запись Рандомного задания создана!: {task} .") # Выводим информацию о пользователе
        ...
        try: # Обработка ошибок при загрузке данных
            ...
            print(Back.RED +"Информация успешно загружена!") # Выводим сообщение о загрузке данных
